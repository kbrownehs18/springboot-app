...
public class AuthCodeUtil {
    ...
    public static void main(String[] args) throws InterruptedException {
        String encode = AuthCodeUtil.encode("scnjl");
        System.out.println(encode);
        String decode = AuthCodeUtil.decode(encode);
        System.out.println(decode);

        encode = AuthCodeUtil.encode("scnjl", 3);
        System.out.println(encode);
        decode = AuthCodeUtil.decode(encode);
        System.out.println(decode);

        encode = AuthCodeUtil.encode("scnjl", "scnjl");
        System.out.println(encode);
        decode = AuthCodeUtil.decode(encode, "scnjl");
        System.out.println(decode);

        System.out.println(AuthCodeUtil.decode("421081fcxhdzls1Ee+oLOBfWjhtGKjFG2o9c8W607HnUz+FwIA=="));
